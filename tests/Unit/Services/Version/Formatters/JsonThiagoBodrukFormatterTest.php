...
use App\Services\Version\Formatters\JsonThiagoBodrukFormatter;
...
describe('JsonThiagoBodrukFormatter', function () {
    beforeEach(function () {
        $this->formatter = new JsonThiagoBodrukFormatter();
    });

    it('formats valid json to DTO', function () {
        $json = json_encode([
        ...
        $result = $this->formatter->format($files);
